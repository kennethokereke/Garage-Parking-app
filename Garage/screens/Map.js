...
const parkingsSpots = [
  {
    id: 1,
    title: 'NYC Parking 785 Garage Corp',
    price: 5,
    rating: 4.2,
    spots: 20,
    free: 10,
...
Secure with CTV`,
  ...
  {
    id: 2,
    title: 'NYC Parking 160 Parking Corp',
    price: 7,
    rating: 3.8,
    spots: 25,
    free: 20,
...
Secure with CTV`,
  ...
  {
    id: 3,
    title: 'NYC Parking 315 E 70 Garage Corp',
    price: 10,
    rating: 4.9,
    spots: 50,
    free: 25,
    ...
    return (
      <View style={styles.header}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          ...
          <Text style={styles.headerLocation}>New York, US</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  markerPrice: { color: theme.COLORS.purple, fontWeight: 'bold', },
